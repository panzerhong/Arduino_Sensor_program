/* Arduino Motion Sensor Burglar Alarm Project by Arvind Sanjeev 
Please check out http://diyhacking.com for the tutorial of this project. 
DIY Hacking */ 
int speakerOut = 9;// Piezo buzzer's positive terminal is connected to digitalpin 9
...
{
  Serial.begin(115200);
  attachInterrupt(0,intruder_detect,RISING);// Initialize the interrupt pin for the motion sensor (Arduino digital pin2)
  intruder=0;
}
void loop()
{
